...
def main():
 TEMPERATURE_VIOLATION_LIMIT= 3
 BATTERY_VIOLATION_LIMIT = 3
 ...
 for satellite in satellite_dictionary.values():
  if satellite.temperature_violation_counter >= TEMPERATURE_VIOLATION_LIMIT:
   firstOccurences.append(satellite.temperature_violation_list[0])
  if satellite.battery_violation_counter >= BATTERY_VIOLATION_LIMIT:
